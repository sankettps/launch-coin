...
/*------------------------------------------*/
 $("#clients").owlCarousel({
     autoPlay: 3000, items: 1, itemsDesktop: [1200, 1], itemsDesktopSmall: [991, 1], itemsTablet: [768, 1], itemsMobile: [480, 1], slideSpeed: 900, navigation: false, pagination: false, 
}
);
/*------------------------------------------*/
/* 
